...
public class IndexImageDepth8_3 {
	...
	public static List<Byte> getBytes() {
		...
		System.out.println("The image width * heigth is " + dataList.size());
		return dataList;
	}
...
//		getBytes();
		...
		ImageData imageData = new ImageData(48, 48, 8, paletteData, 4, listByte2byteArray(getBytes()));
	...
	public static void main(String[] args) {
		...
		canvas.addPaintListener (new PaintListener () {
			public void paintControl (PaintEvent e) {
				...
				e.gc.drawString("IndexImageDepth8_3", 20, 100);
			}
		});
		shell.setText("IndexImageDepth8_3");
