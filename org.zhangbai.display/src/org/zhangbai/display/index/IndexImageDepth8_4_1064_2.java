...
public class IndexImageDepth8_4_1064_2 {

	
	private static final String constVar = "IndexImageDepth8_4_1064_2";
...
//		System.out.println("The image heigth is " + validateStrings.size());
	...
	public static Image createIndexImage() {
		ImageData imageData = new ImageData(48, 48, 8, MyPaletteData.createPaletteAsLidar256(), 4, listByte2byteArray(getBytes()));
